...
class ModeloNoticias{
    /**Mostrar NOTICIAS */
    static public function mdlMostrarNoticias($tabla, $item, $campo){
        if ($item != null) {
     ...
     * CREAR NOTICIAS
     */
    static public function mdIgresarNoticias($tabla,$parametros){
     ...
     * EDITAR NOTICIAS
     */
    static public function mdIEditarNoticias($tabla, $parametros, $id){
     ...
     * ELIMINAR NOTICIAS
     ...
     static public function MdlEliminarNoticias($item, $campo, $tabla){
