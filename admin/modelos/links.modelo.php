...
class ModeloLinks{
    /**Mostrar NOTICIAS */
    static public function mdlMostrarLink($tabla, $item, $campo){
        if ($item != null) {
     ...
     * CREAR NOTICIAS
     */
    static public function mdIgresarLink($tabla,$parametros){
     ...
     * EDITAR NOTICIAS
     */
    static public function mdIEditarLink($tabla, $parametros, $id){
