...
class ModeloSociales{
    /**Mostrar NOTICIAS */
    static public function mdlMostrarSocial($tabla, $item, $campo){
        if ($item != null) {
     ...
     * CREAR NOTICIAS
     */
    static public function mdIgresarSocial($tabla,$parametros){
     ...
     * EDITAR NOTICIAS
     */
    static public function mdIEditarSocial($tabla, $parametros, $id){
     ...
     * ELIMINAR NOTICIAS
     ...
     static public function MdlEliminarLink($item, $campo, $tabla){
