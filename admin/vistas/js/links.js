...
$(document).on("click", ".btnEditarLink", function () {
   let idLink = $(this).attr("idLink");
   console.log(idLink + 'archivo noticias');
   let datos = new FormData();
   //le estoy pasando un identificador y un valor
   datos.append("idLink", idLink);

   $.ajax({
      url: "ajax/links.ajax.php",
      method: "POST",
      data: datos,
      cache: false,
      contentType: false,
      ...
      success: function (respuesta) {
         ...
         $("#editarsocial").val(respuesta['rsocial']);
         $("#editarvideo").val(respuesta['livideo']);
